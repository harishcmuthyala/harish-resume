...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Designed \textbf{few-shot prompt templates} using \textbf{Langchain}, improving generative accuracy for processing complex financial notations.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Streamlined \textbf{CI/CD processes} for dataset ingestion and dashboard deployment, improving update velocity across accounts.}
      \resumeItemListEnd
